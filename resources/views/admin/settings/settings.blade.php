        ...
        <div class="page-wrapper">
            <div class="page-body">
                <div class="container-xl">
                    <div class="card">
                        <div class="card-body">
                            <h2><i class="ti ti-settings me-2"></i>SYSTEM SETTINGS</h2>
                        </div>
                        <hr class="my-0">
                        <div class="row g-0">
                                    ...
                                    <form id="systemSettingsForm" action="{{ route('admin.setting.update') }}"
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Interface Layout</h3>
                                                    <p class="text-muted mb-0 small">Customize your navigation and layout
                                                        preferences</p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            ...
                                                            <label class="form-check-label">Enable Sidebar Lock</label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Theme Configuration</h3>
                                                    <p class="text-muted mb-0 small">Control the visual appearance and theme
                                                        settings</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Notifications & Alerts</h3>
                                                    <p class="text-muted mb-0 small">Manage notification preferences and
                                                        alert settings</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <div class="form-check form-switch mb-2">
                                                            ...
                                                            <label class="form-check-label">Enable Sound
                                                                Notifications</label>
                                                        </div>
                                                        <div class="form-check form-switch mb-2">
                                                            <input class="form-check-input" type="checkbox"
                                                            ...
                                                            <label class="form-check-label">Enable Browser
                                                                Notifications</label>
                                                        </div>
                                                        <div class="form-check form-switch mb-2">
                                                            <input class="form-check-input" type="checkbox"
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Session & Security</h3>
                                                    <p class="text-muted mb-0 small">Configure session timeout and security
                                                        preferences</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check form-switch">
                                                            ...
                                                            <label class="form-check-label">Remember Last Visited
                                                                Page</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Performance</h3>
                                                    <p class="text-muted mb-0 small">Optimize system performance and
                                                        resource usage</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                        ...
                                        <div class="settings-section mb-5">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    <h3 class="mb-1">Language & Localization</h3>
                                                    <p class="text-muted mb-0 small">Set your preferred language and
                                                        regional settings</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                        ...
                                        <div class="settings-section mb-4">
                                            <div class="settings-section-header">
                                                ...
                                                <div class="settings-section-title">
                                                    ...
                                                    <p class="text-muted mb-0 small">Additional options for power users and
                                                        debugging</p>
                                                </div>
                                            </div>
                                            <div class="settings-section-content">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <div class="form-check form-switch mb-2">
                                                            ...
                                                            <label class="form-check-label">Enable Debug
                                                                Information</label>
                                                        </div>
                                                        <div class="form-check form-switch mb-2">
                                                            <input class="form-check-input" type="checkbox"
                                                            ...
                                                            <label class="form-check-label">Enable Keyboard
                                                                Shortcuts</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
