                            ...
                            <div class="mb-5 border-bottom pb-4">
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-control-plaintext fw-bold">
                                            ...
                                            <span class="text-muted">({{ App\Helpers\CurrencyHelper::format($por->purchase->total) }})</span>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="reason" class="form-control @error('reason') is-invalid @enderror" rows="3"
                                        placeholder="{{ __('messages.enter_reason_for_return') }}">{{ old('reason', $por->reason) }}</textarea>
                                    @error('reason')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
