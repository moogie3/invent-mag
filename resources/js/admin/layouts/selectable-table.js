    ...
    tables.forEach((table) => {
        ...
        const updateSelection = (newIndex) => {
            ...
            const itemNameElement =
                rows[currentRowIndex].querySelector(".sort-name") ||
                rows[currentRowIndex].querySelector("td:nth-child(3)");
        ...
        const performAction = (selectedRow, actionType) => {
            ...
            if (actionType === "edit") {
                ...
                selector =
                    'button.dropdown-item[data-bs-target="#deleteUserModal"]';
            } else {
                selector =
                    'button.dropdown-item[data-bs-target="#deleteModal"]';
            }
            ...
            if (dropdownToggle) {
                    ...
                    if (openDropdownMenu) {
                        ...
                        if (actionType === "edit") {
                            const allDropdownItems =
                                openDropdownMenu.querySelectorAll(
                                    ".dropdown-item"
                                );
                            ...
                            actionButton = openDropdownMenu.querySelector(
                                'button.dropdown-item[data-bs-target="#deleteUserModal"]'
                            );
                            if (!actionButton) {
                                actionButton = openDropdownMenu.querySelector(
                        ...
                        if (actionButton) {
                            ...
                            if (
                                ...
                                window.InventMagApp.showToast(
                                    "Error",
                                    `Could not find ${actionName} button for the selected item.`,
                                    "error"
                                );
                            }
                        }
                        ...
                        if (
                            ...
                            window.InventMagApp.showToast(
                                "Error",
                                `Dropdown menu did not open correctly.`,
                                "error"
                            );
                        }
                    }
                ...
                if (window.InventMagApp && window.InventMagApp.showToast) {
                    window.InventMagApp.showToast(
                        "Error",
                        `Could not find action dropdown for the selected item.`,
                        "error"
                    );
                }
            }
