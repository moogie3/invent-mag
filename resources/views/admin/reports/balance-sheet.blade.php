    ...
    <div class="page-wrapper">
        <div class="container-xl">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">{{ __('messages.as_of') }}: {{ \Carbon\Carbon::parse($endDate)->format('M d, Y') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.reports.balance-sheet') }}" method="GET" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 d-flex align-items-end">
                                    <button type="submit" class="btn btn-primary">{{ __('messages.generate_report') }}</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="report-section accounting-equation mt-5 border-top pt-3">
                            ...
                            <h3 class="d-flex justify-content-between text-success">
                                ...
                                <span class="text-end">{{ $equation_balanced ? __('messages.yes') : __('messages.no') }}</span>
                            </h3>
                        </div>
                    </div>
                </div>
