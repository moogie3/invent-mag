                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="fw-bold fs-4" id="totalProductCount">{{ $totalproduct }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="me-3 d-flex align-items-center justify-content-center rounded badge"
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="fw-bold fs-4" id="totalCategoryCount">{{ $totalcategory }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="h4 mb-0 {{ $lowStockCount > 0 ? 'text-danger' : 'text-success' }}"
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="h4 mb-0 {{ $expiringSoonCount > 0 ? 'text-warning' : 'text-success' }}"
