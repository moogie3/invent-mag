            ...
            <div class="col">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-muted fs-5">{{ $pos->supplier->code }} - {{ $pos->supplier->location ?? 'N/A' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card bg-light border-0 h-100">
                    <div class="card-body p-3">
                        <h4 class="card-title mb-3"><i class="ti ti-building-store me-2 text-primary"></i>Supplier</h4>
                        <h5 class="mb-2">{{ $pos->supplier->name }}</h5>
                        <div class="text-muted mb-1"><i class="ti ti-map-pin me-1"></i> {{ $pos->supplier->address }}
                        </div>
                        <div class="text-muted mb-1"><i class="ti ti-phone me-1"></i> {{ $pos->supplier->phone_number }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 bg-light">
                    <div class="card-body p-3">
                        ...
                        <div class="mb-2">
                            <i class="ti ti-receipt me-1"></i> Payment Type: <strong>{{ $pos->payment_type }}</strong>
                        </div>
                ...
                <div class="card border">
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="text-danger">- {{ \App\Helpers\CurrencyHelper::format($orderDiscount) }}</div>
                        </div>
                        <hr>
