        ...
        <div class="modal-content">
            ...
            <form id="convertOpportunityForm" method="POST">
                ...
                <div class="modal-body">
                    <p>{{ __('messages.sales_pipeline_modal_convert_to_sales_order_message') }}</p>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h3 id="confirmationModalBodyTitle">{{ __('messages.are_you_sure') }}</h3>
                <div class="text-muted" id="confirmationModalBody">
                    {{ __('messages.sales_pipeline_modal_delete_item_message') }}
                </div>
            </div>
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <form id="deleteConfirmationForm" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger w-100" id="confirmationModalConfirm">
                                    {{ __('messages.confirm') }}
                                </button>
                            </form>
                        </div>
