...
class SettingsController extends Controller
{
    ...
    public function applyCoaTemplate(Request $request)
    {
        ...
        $templatePath = database_path("data/coa_templates/{$templateName}.json");
        ...
        return redirect()->route('admin.setting.index')->with('success', 'Chart of Accounts template applied successfully.');
    }
    ...
    public function accounting()
    {
        ...
        $settings = Auth::user()->accounting_settings ?? [];

        return view('admin.settings.accounting', compact('accounts', 'settings'));
    }
