    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header border-bottom-0 pb-0">
                <h3 class="modal-title fw-semibold">{{ __('user_modal_create_title') }}</h3>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="modal-body pt-2">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">{{ __('table_name') }}</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">{{ __('confirm_new_password') }}</label>
                            <input type="password" name="password_confirmation" class="form-control" required>
                        </div>

                    </div>

                    <h3 class="card-title mt-4 fw-semibold">{{ __('user_modal_assign_roles') }}</h3>
                    <div class="mb-3">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUserModalLabel">{{ __('user_modal_edit_user') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editUserForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">{{ __('user_modal_password_leave_empty') }}</label>
                    ...
                    <h3 class="card-title mt-4">{{ __('user_modal_assign_roles') }}</h3>
                    <div class="mb-3" id="edit_roles_container">
                        <!-- Roles will be loaded here via JavaScript -->
                    </div>

                    <h3 class="card-title mt-4">{{ __('user_modal_assign_direct_permissions') }}</h3>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('user_modal_update_user') }}</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal modal-blur fade" id="deleteUserModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('user_modal_delete_user_title') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">{{ __('user_modal_delete_user_warning') }}</div>
            </div>
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
