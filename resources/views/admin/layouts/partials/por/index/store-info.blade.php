                ...
                <div class="card-body border-bottom py-3">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="mb-1">{{ __('messages.model_purchase_return') }}</h2>
                                <div class="text-muted">{{ __('messages.overview_of_purchase_returns') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body py-3">
                                    <div class="mb-2">
                                        <label
                                            class="form-label text-muted mb-2 d-block">{{ __('messages.return_summary') }}</label>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="fw-bold fs-4">
                                                {{ App\Helpers\CurrencyHelper::format($total_amount) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="card border-0 bg-warning text-white h-100">
                                <div class="card-body py-3">
                                    <div class="mb-2">
                                        <label
                                            class="form-label text-white-50 mb-2 d-block">{{ __('messages.return_status') }}</label>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    <div class="text-white-50 small">{{ __('messages.completed') }}
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="text-white-50 small">{{ __('messages.canceled') }}
                                                    </div>
                        ...
                        <div class="col-lg-3 col-md-12">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body py-3">
                                    @include('admin.layouts.partials.por.index.filters')
                                </div>
                            </div>
                        </div>
                    </div>
